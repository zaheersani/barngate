			...
			<?php endif; ?>
				<div id="primary" class="content-area">
					<main id="main" class="site-main">
                        <h1 class="blog-title">All the information you need to buy a horse online, cattle, goat, sheep, pig and pets.</h1>
					<?php
					...
					if ( have_posts() ) :
						...
						the_posts_navigation( array(
							'next_text' => esc_html__( 'Entradas recientes', 'wp-bootstrap-4' ),
							'prev_text' => esc_html__( 'Entradas antiguas', 'wp-bootstrap-4' ),
						) );
